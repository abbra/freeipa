...
"""Shared utility functions for IPAthinCA REST API blueprints."""
...
from ipathinca.rest_api_helpers import success_response
...
def _search_certificates(request, ca_backend):
    ...
    """
    from ipathinca.rest_api_helpers import CertificateHandler
