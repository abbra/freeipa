...
from ipathinca.rest_api._globals import init_ca
from ipathinca.rest_api._utils import _build_pkcs7_chain_pem
...
@bp.route("/ca/rest/ca/authorities/<authority_id>/chain", methods=["GET"])
...
@bp.route("/ca/rest/authorities/<authority_id>/disable", methods=["POST"])
@bp.route("/ca/rest/ca/authorities/<authority_id>/disable", methods=["POST"])
@bp.route("/ca/v2/authorities/<authority_id>/disable", methods=["POST"])
@bp.route("/ca/v2/ca/authorities/<authority_id>/disable", methods=["POST"])
@require_agent_auth
...
@bp.route("/ca/rest/authorities/<authority_id>/enable", methods=["POST"])
@bp.route("/ca/rest/ca/authorities/<authority_id>/enable", methods=["POST"])
@bp.route("/ca/v2/authorities/<authority_id>/enable", methods=["POST"])
@bp.route("/ca/v2/ca/authorities/<authority_id>/enable", methods=["POST"])
@require_agent_auth
