...
"""Debug / diagnostics endpoints for ipathinca.
...
from ipathinca.rest_api_helpers import require_agent_auth
...
def resources():
    ...
    section of ``ipathinca.conf`` before starting the service, or set the
    environment variable ``IPATHINCA_TRACEMALLOC=1``.
    """
    from ipathinca.resource_tracker import get_snapshot
    snap = get_snapshot()
