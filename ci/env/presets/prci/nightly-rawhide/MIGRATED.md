# PRCI -> freeipa-env migration: nightly_rawhide.yaml

Source: `../../ipatests/prci_definitions/nightly_rawhide.yaml`
...
- `fedora-rawhide/build`: class Build: replaced by the freeipa-ci image pipeline
- `fedora-rawhide/nfs_automountdiscovery`: class RunPytest / topology ipa_ipa_trust: not mappable
...
- test: `test_integration/test_commands.py`
