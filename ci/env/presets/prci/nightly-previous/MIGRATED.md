# PRCI -> freeipa-env migration: nightly_previous.yaml

Source: `../../ipatests/prci_definitions/nightly_previous.yaml`
...
- `fedora-previous/build`: class Build: replaced by the freeipa-ci image pipeline
- `fedora-previous/nfs_automountdiscovery`: class RunPytest / topology ipa_ipa_trust: not mappable
...
### `test_installation_client`  (integration, 3 IPA host(s))
