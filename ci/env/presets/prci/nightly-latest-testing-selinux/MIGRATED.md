# PRCI -> freeipa-env migration: nightly_latest_testing_selinux.yaml

Source: `../../ipatests/prci_definitions/nightly_latest_testing_selinux.yaml`
...
- `testing-fedora/build`: class Build: replaced by the freeipa-ci image pipeline
- `testing-fedora/nfs_automountdiscovery`: class RunPytest / topology ipa_ipa_trust: not mappable
...
### `test_caless_testrsnvault`  (integration, 2 IPA host(s))
