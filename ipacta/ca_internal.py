...
This is the CA implementation used by the FreeIPA ipacta service through
...
When to use InternalCA:
    - Production IPA deployments (ipacta service) ← PRIMARY USE
...
from ipacta.audit import audit_logger, AuditOutcome
        ...
        try:
            ...
            if not is_main_ca:
                ...
                try:
                    ...
                    if subca and subca.ca_cert and subca.ca_key:
                        ...
                        # Legitimate NotFound — already logged in get_subca
                        raise errors.NotFound(
            ...
            for attempt in range(max_retries):
                ...
                if is_dogtag:
                    ...
                    default_alg = ipacta.get_config_value(
                        "ca",
                    ...
                    signing_alg = ipacta.get_config_value(
                        "ca",
                        "default_signing_algorithm",
                        default="SHA256withRSA",
                    )
