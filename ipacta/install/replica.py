...
class Replication:
    ...
    def update_topology(self):
        ...
        Uses the shared ca-topology.uldif which handles $FQDN substitution
        automatically via LDAPUpdate and is idempotent (default: directives).
        """
        self._ldap_update([paths.CA_TOPOLOGY_ULDIF], basedir=None)
