...
LDAP Storage:
    ...
    to ipacta, not an optional feature. The storage layer handles:
...
from ipacta.certificate_types import (  # noqa: F401 pylint: disable=W0611
    CertificateStatus,
    RevocationReason,
    CertificateRequest,
    CertificateRecord,
...
class PythonCA:
    ...
    def __init__(
        ...
        # Initialize storage backend (LDAP required for ipacta)
    ...
    def _load_ca_cert_and_key(self):
        ...
        try:
            ...
            # Load CA certificate (always from file for ipacta)
