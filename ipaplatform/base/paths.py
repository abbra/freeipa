...
class BasePathNamespace:
    ...
    IPACTA_CONF = "/etc/ipa/ipacta.conf"
    IPACTA_PID = "/run/ipacta/ipacta.pid"
    IPACTA_DIR = "/var/lib/ipacta/"
    IPACTA_LOG_DIR = "/var/log/ipacta/"
    IPACTA_CERTS_DIR = IPACTA_DIR + "certs/"
    IPACTA_PRIVATE_DIR = IPACTA_DIR + "private/"
    IPACTA_CA_DIR = IPACTA_DIR + "ca/"
    IPACTA_SUBCAS_DIR = IPACTA_CA_DIR + "subcas/"
    IPACTA_AUDIT_DIR = IPACTA_DIR + "audit/"
    IPACTA_SIGNING_KEY = IPACTA_CA_DIR + "ca_signing.key"
    IPACTA_SERVER_CERT = IPACTA_CERTS_DIR + "server_cert.pem"
    IPACTA_SERVER_KEY = IPACTA_PRIVATE_DIR + "server_key.pem"
    IPACTA_AUDIT_SIGNING_KEY = IPACTA_AUDIT_DIR + "audit_signing.key"
    IPATHINCA_CONF = "/etc/ipa/ipathinca.conf"
    IPATHINCA_PID = "/run/ipathinca/ipathinca.pid"
    IPATHINCA_DIR = "/var/lib/ipathinca/"
    IPATHINCA_LOG_DIR = "/var/log/ipathinca/"
    IPATHINCA_CERTS_DIR = IPATHINCA_DIR + "certs/"
