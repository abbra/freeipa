...
class BasePathNamespace:
    ...
    AKAMU_STATE_DIR = '/var/lib/akamu'
    AKAMU_EAB_MASTER_SECRET = '/var/lib/akamu/eab_master_secret'
    AKAMU_RA_AGENT_PEM = '/var/lib/akamu/akamu-ra-agent.pem'
    AKAMU_RA_AGENT_KEY = '/var/lib/akamu/akamu-ra-agent.key'
    AKAMU_SOCKET_DIR = '/run/akamu'
    AKAMU_SOCKET = '/run/akamu/akamu.sock'
    AKAMU_GSSPROXY_CONF = '/etc/gssproxy/20-akamu.conf'
    AKAMUCTL = '/usr/bin/akamuctl'
    AKAMU_WEBUI_DIR = '/usr/share/akamu/webui'
